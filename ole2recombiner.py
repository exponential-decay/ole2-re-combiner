...
def main():
    ...
    parser.add_argument(
        "--combine", help="Optional: Directory to combine into OLE2.", default=False
    )
    parser.add_argument("--ext", help="Optional: Extension for OLE2.", default="")
    parser.add_argument(
        "--blanksummary",
        help="Optional: Replace SummaryInfo with a blank SummaryInfo.",
        default=False,
    )
    parser.add_argument(
        "--fixsummary",
        help="Optional: Try to retrieve old SummaryInfo and fix.",
        default=False,
    )
    parser.add_argument(
        "--blankdocumentsummary",
        help="Optional: Replace DocumentSummaryInformation with a blank DocumentSummaryInformation.",
        default=False,
    )
    parser.add_argument(
        "--fixdocumentsummary",
        help="Optional: Try to retrieve old DocumentSummaryInformation and fix.",
        default=False,
    )
